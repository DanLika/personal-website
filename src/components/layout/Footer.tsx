...
export const Footer = () => {
  ...
  return (
    <footer className="relative w-full mt-auto">
      <div className={`${layout.container} pb-4 sm:pb-6`}>
      {/* Card container */}
      <div className="relative bg-black/60 border border-white/10 backdrop-blur-md rounded-2xl overflow-hidden">
        {/* Subtle Glow */}
        <div className="absolute inset-0 bg-gradient-to-r from-cyan-500/3 via-transparent to-blue-500/3 pointer-events-none" />

        <div className="relative z-10 px-4 sm:px-6 md:px-8 py-3 md:py-4">
          {/* Desktop Layout */}
          <div className="hidden md:flex items-center justify-between">
            ...
            >
              <div className="px-4 py-1.5 rounded-full bg-white/5 border border-white/10 backdrop-blur-sm flex items-center gap-2">
                <motion.div
                  animate={{ rotate: 360 }}
          ...
          {/* Mobile Layout */}
          <div className="md:hidden flex flex-col items-center gap-2.5 text-center">
