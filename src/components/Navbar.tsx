...
export const Navbar = () => {
  ...
  return (
    <>
      ...
      {/* Mobile Navbar */}
      <nav className="md:hidden fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-6 h-20 bg-black/90 backdrop-blur-xl border-b border-white/10">
        {/* Logo */}
        <div className="text-xl font-bold text-neon drop-shadow-[0_0_8px_rgba(59,201,255,0.8)]">
          licanin
        </div>
