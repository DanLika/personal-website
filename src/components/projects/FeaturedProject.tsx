        ...
        <img
          ...
          onError={(e) => {
            ...
            if (parent) {
              ...
              fallbackSpan.className = 'text-cyan-400 text-xs font-bold';
              fallbackSpan.textContent = name.slice(0, 3).toUpperCase();
          ...
          >
            ...
            <div className="relative z-10 grid md:grid-cols-2 gap-8 md:gap-12 p-6 md:p-12 lg:p-16">
              ...
              >
                ...
                <h2 className="text-2xl sm:text-[28px] md:text-[32px] lg:text-4xl xl:text-[40px] 2xl:text-[44px] font-bold font-space text-white leading-tight line-clamp-2 group-hover:text-cyan-400 transition-colors duration-300">
                ...
                {/* View Case Study Button - Only this navigates */}
                <div className="pt-2">
                  <Link
                    to="/case-study/bookbed-saas"
