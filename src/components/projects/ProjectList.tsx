        ...
        <img
          ...
          onError={(e) => {
            ...
            if (parent) {
              ...
              fallbackSpan.textContent = tech.slice(0, 2).toUpperCase();
          ...
          {projects.map((project, index) => (
            ...
            >
              ...
              <div className="relative">
                ...
                <motion.div
                  className="project-card relative rounded-[30px] border border-white/10 overflow-visible transition-all duration-300"
                  style={{
